    ...
    return (
        <PageContainer>
            <div className="flex flex-col items-center justify-center min-h-[calc(100vh-250px)] text-center px-4 animate-fadeIn">
                ...
                <h1 className="text-4xl sm:text-5xl font-extrabold text-brand-gradient mb-4 tracking-tight">
                    Crea tu Asistente con IA
                </h1>

                <p className="mt-2 max-w-xl mx-auto text-lg text-muted-foreground">
                    Describe tu asistente en el recuadro y nuestra IA lo creará para ti.
                </p>
                ...
                <Card className="w-full max-w-xl mt-10 shadow-lg">
                   <CardContent className="p-6 space-y-4">
                    ...
                    <Button 
                        ...
                        disabled={isCreating}
                    >
                        {isCreating ? 'Generando...' : <><Wand2 className="w-5 h-5"/> Crear Asistente</>}
                    </Button>
                   </CardContent>
                </Card>
            </div>
