          ...
          <div className="container mx-auto px-4 relative z-10 grid md:grid-cols-2 gap-8 items-center">
              ...
              >
                  ...
                  <div className="mt-8 flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
                    <Button asChild size="lg" className="w-full sm:w-auto bg-green-500 text-primary-foreground hover:bg-green-600 shiny-border">
                        <Link href={"/load"}>
              ...
              <motion.div 
                className="mt-12 h-[500px] w-full max-w-sm mx-auto flex items-center justify-center"
