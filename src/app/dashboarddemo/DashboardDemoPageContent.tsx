      ...
      <PageContainer className="space-y-5"> 
        <div className="animate-fadeIn">
          ...
          <p className="text-xs text-muted-foreground">
             ...
             {pathname.startsWith('/dashboarddemo/databases') && 'Administra las fuentes de datos conectadas a tus asistentes.'}
             {pathname.startsWith('/dashboarddemo/profile') && 'Administra tu información, apariencia y obtén ayuda.'}
             {pathname === '/dashboarddemo' && 'Explora las funciones con datos de ejemplo.'}
          </p>
        </div>
